    ...
    try {
        ...
        if (explanationJustFetched && isNewWordBeingAddedToStreak) {
            if (authToken) {
                try {
                    ...
                    if (quizResp.ok) {
                        ...
                        if (parsedQs.length > 0) {
                            setLiveStreakQuizQueue(prevQ => [...prevQ, { word: wordToFetch, originalExplanation: explanationJustFetched, quizQuestion: parsedQs[0], attempted: false, isLocked: false }]);
                        }
                    }
                ...
                setLiveStreakQuizQueue(prevQ => [...prevQ, placeholderQuiz]);
            }
        }
    } catch (err) {
