                ...
                {loggedIn && isExplainGeneratedForCurrentWord && inputQuestion.trim() !== '' && generatedContents[activeMode] && (
                    <button
                        onClick={() => {
                            ...
                            setAiError(null);
                            // Directly call generateExplanation for the currently active mode to refresh it
                            generateExplanation(inputQuestion, activeMode);
                        }}
                        className="p-1.5 rounded-full text-blue-600 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors duration-150 ml-2"
