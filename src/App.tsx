...
function App() {
  ...
  // NEW: State for settings modal and custom API key
  ...
  // MODIFIED: To add custom API key and error messages
        ...
        if (!response.ok) {
            if (response.status === 429) {
                if (authToken) {
                    ...
                    throw new Error("Free daily limit reached. Please sign in to upgrade to Pro or use your own API key for unlimited generations.");
                }
            }
  ...
  // ... (Other handlers like handleStreakWordClick, etc., are unchanged)
  ...
  // ... (renderAuthModal, renderExploreModeContent are unchanged)
          ...
          <div className="flex-grow space-y-1">
            ...
            {currentUser && (
              <>
                ...
                {/* MODIFIED: Enabled settings button */}
